(function($){
	...
	$(document).ready(function(){
		...
		$('#header_style').change(function(){
			...
			$('#header').addClass('style'+$(this).val()+' cta_button' );
		...
		function changeColor(hex) {
			...
			style.html(
				...
				'nav#main_menu > ul > li.active > a, nav#main_menu > ul > li > a:hover, nav#main_menu > ul > li:hover > a, .social-icons li a:hover, #action_box, body .circlehover, body .iosSlider .item .caption.style2 .more  {background-color:' + hex + ';}'+
				...
				'body .iosSlider .item .caption.style2 .title_big, body .iosSlider .item .caption.style2 .title_small {border-left: 5px solid ' + hex + '; }'+
